...
-- -----------------------------------------------------
-- Table `banco_pradoc`.`responsavel_avaliacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `banco_pradoc`.`responsavel_avaliacao` (
  `id_avaliador` INT NOT NULL,
  `id_participacao` INT NOT NULL,
  INDEX `fk_responsavel_avaliacao_id_avaliador_idx` (`id_avaliador` ASC),
  INDEX `fk_responsavel_avaliacao_id_participacao_idx` (`id_participacao` ASC))
ENGINE = InnoDB;
